...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    const users: IUserModel[] = [
      ...
      { id: 3, username: 'joebloggs', email: 'joe.bloggs@academytrainee.com', firstName: 'Joe', lastName: 'Bloggs', roles: ['training-user', 'training-admin'], cohorts: ['cohort_CI_Intake_1'] },
