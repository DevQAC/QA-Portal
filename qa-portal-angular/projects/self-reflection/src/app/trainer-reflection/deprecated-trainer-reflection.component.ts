...
import {DeprecatedTrainerReflectionService} from './services/deprecated-trainer-reflection.service';
...
@Component({
  ...
  templateUrl: './deprecated-trainer-reflection.component.html',
  styleUrls: ['./deprecated-trainer-reflection.component.css']
})
export class DeprecatedTrainerReflectionComponent implements OnInit {
  ...
  constructor(
    private reflectionService: DeprecatedTrainerReflectionService,
