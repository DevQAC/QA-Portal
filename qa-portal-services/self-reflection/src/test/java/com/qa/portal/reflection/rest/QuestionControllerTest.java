...
public class QuestionControllerTest {
	 ...
	 * LoggerFactory.getLogger(QuestionControllerTest.class);
	 * 
	 ...
	 * @Test
	 * 
	 * @FlywayTest public void testGetUserRoles() { try { ResponseEntity<Set>
	 * response = restTemplate.getForEntity(createURLWithPort(
	 * "/self-reflection-api/question/cohort/1"), Set.class);
	 * response.getBody().stream().forEach(q -> LOGGER.info(q.toString()));
	 * assertThat(6, equalTo(response.getBody().size())); } catch (Exception e) {
