...
enum FontSize {
	CONSULTANT_NAME(20), SIDEBAR_TITLES(11), SIDEBAR_CONTENT(10), SIDEBAR_TITLE_CONTENT_SPACING(4), BODY_TITLES(12),
	BODY_CONTENT(9), BODY_TITLE_CONTENT_SPACING(5), BODY_SUBTITLE_CONTENT_SPACING(4);
	final int value;
...
enum PageFormat {
	WIDTH(595.27563f), HEIGHT(841.8898f), WIDTH_COL1(WIDTH.value / 3 + 4.5f),
	WIDTH_COL2(WIDTH.value - WIDTH_COL1.value), PADDING(20);
	final float value;
...
enum QualificationsBox {
	...
	HEIGHT(PageFormat.HEIGHT.value - ConsultantNameBox.HEIGHT.value - SkillsBox.HEIGHT.value), X_POSITION(0),
...
enum MainHeader {
	...
	X_POSITION(PageFormat.WIDTH_COL1.value), Y_POSITION(PageFormat.HEIGHT.value);
	final float value;
...
enum MainBody {
	...
	X_POSITION(PageFormat.WIDTH_COL1.value), Y_POSITION(PageFormat.HEIGHT.value - MainHeader.HEIGHT.value);
	final float value;
