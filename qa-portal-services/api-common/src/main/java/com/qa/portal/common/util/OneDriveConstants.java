...
public class OneDriveConstants {
    ...
    public static final String ONE_DRIVE_RESOURCE_BASE_URL = "onedrive.url";

    public static final String ONE_DRIVE_BASE_FOLDER = "onedrive.baseFolder";

    public static final String ONE_DRIVE_ACTIVE_FLAG = "onedrive.isActive";

    public static final String ONE_DRIVE_ACTIVE_TRUE_VALUE = "true";

    public static final String CLIENT_CREDENTIALS_PARM_VALUE = "client_credentials";

    public static final String UTF_8_STRING = "utf-8";

    public static final String MAX_CONNECTIONS_TOTAL = "onedrive.connections.max.total";

    public static final String MAX_CONNECTIONS_PER_ROUTE = "onedrive.connections.per.route";
